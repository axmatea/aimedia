      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-white/55 text-sm leading-relaxed">
          <section>
            ...
            <p>By accessing or using AX Media's website and services, you agree to be bound by these Terms of Service. If you do not agree, do not use our services.</p>
          </section>
          ...
          <section>
            ...
            <p>AX Media's total liability for any claim shall not exceed the total fees paid in the three months preceding the claim. We are not liable for indirect, incidental, or consequential damages.</p>
          </section>
          ...
          <section>
            ...
            <p>Legal inquiries: <span className="text-white/70">legal@axmedia.co</span></p>
          </section>
        </div>
