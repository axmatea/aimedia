  ...
  return (
    <div className="rounded-3xl overflow-hidden border border-[#7B2FFF]/15 bg-[#0A0518] p-6 md:p-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <p className="text-white/40 text-[10px] font-mono uppercase tracking-widest">Lead Pipeline — Live</p>
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-white/60 text-[10px] font-bold uppercase tracking-wider">{stage.label}</span>
      ...
      <div className="flex items-center justify-between mt-5 pt-4 border-t border-white/5">
        <div className="flex items-center gap-4">
          <div>
            ...
            <p className="text-white/25 text-[9px] font-mono">Reply rate</p>
          </div>
          <div>
            <p className="text-[#7B2FFF] text-sm font-bold font-mono">$2.4M</p>
            <p className="text-white/25 text-[9px] font-mono">Pipeline value</p>
          </div>
        </div>
        <p className="text-white/15 text-[9px] font-mono">Updated 3s ago</p>
      </div>
    </div>
  )
}
